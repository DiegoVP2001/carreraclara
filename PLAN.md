...
| `web/data/detalle/<slug>.json` | Oferta por carrera (lazy load) |
| `web/data/instituciones.json` | 1690 combos institución × carrera-título |
| `mifuturo/processed/comparador.db` | SQLite fuente de verdad |
| `web/export_json.py` | Regenera `core.json` + `detalle/` |
| `web/export_instituciones.py` | Regenera `instituciones.json` |
| `dev_server.py` | Server local con los rewrites de `vercel.json` (revisión antes de aprobar) |
...
| **24** | Ficha de institución (pantalla nueva) | nuevo archivo | Post-MVP |
| **25** | Drawer glosario completo | `index_v2.html`, `instituciones_v2.html` | Post-MVP |
| **26** | Fuzzy-match arancel Nivel 2 | `mifuturo/`, `export_instituciones.py` | Post-MVP — prioridad mínima |
